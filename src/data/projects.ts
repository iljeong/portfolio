  ...
  },
  {
    ...
    content: {
      ...
      results: [
        ...
        { label: '기술 구현', desc: 'Next.js 16 · React 19 · TypeScript · Supabase · Gemini로 구현했고, cheerio로 상품 페이지 실측 치수를 파싱했습니다.' },
      ...
      architecture: {
        title: '서비스 구조',
        caption: 'Claude Code로 프론트·백엔드를 구현하고 Vercel에 배포한 풀스택 구조.',
        layers: [
          { name: '빌드 · 배포', items: ['Claude Code 구현', 'GitHub Actions CI/CD', 'Vercel'] },
      ...
      contribution: {
        role: '서비스 기획 주도 · UX 설계 (2인 팀, 구현 분담)',
        scope: '문제 정의·사용자 입력 플로우·추천 결과 UX·MVP 범위 정의·Claude Code 기반 프론트엔드·백엔드 구현 분담·서비스 배포',
