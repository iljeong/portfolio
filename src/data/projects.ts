...
export const projects: readonly Project[] = [

  {
    ...
    content: {
      ...
      approach: [
        ...
        { num: '03', step: '상세페이지 구성', desc: '사내 기존 상세페이지와 공개 기획 문서를 분석하고, 판매 데이터에서 반응이 좋았던 구성을 확인해 강의 특성에 맞게 응용' },
      ...
      insights: [
        ...
        { num: '03', title: "상세페이지를 '이해 순서'로 다시 짰다", body: '처음 맡은 상세페이지라 기준이 없었다. 사내 기존 페이지와 공개된 기획 문서를 역추적해 구성 원리를 파악하고, 판매 데이터로 실제 반응이 좋았던 구성을 확인했다. AI 영상 강의에서는 결과물을 앞단에 먼저 보여주는 식으로 강의 특성에 맞춰 응용했다.' },
      ...
      results: [
        { label: '제작 성과', desc: '신규 강의 6개를 기획·출시했습니다. 4개는 직접 기획했고 2개는 PM으로 진행했습니다.' },
  ...
  },
  {
    ...
    content: {
      ...
      results: [
        ...
        { label: '기술 구현', desc: 'Claude Code 기반으로 2인이 함께 개발·배포했습니다. 초기 개발은 협업자 주도로 진행했고, 저는 문제 정의·입력 플로우·추천 결과 UX와 콘텐츠 운영을 맡았습니다.' },
      ...
      architecture: {
        title: '서비스 구조',
        caption: 'Claude Code 기반으로 2인이 함께 개발·배포한 서비스 구조. 초기 개발은 협업자 주도로 진행했습니다.',
        layers: [
          { name: '빌드 · 배포', items: ['Claude Code 기반 2인 공동 개발·배포', 'GitHub Actions CI/CD', 'Vercel'] },
      ...
      contribution: {
        role: '서비스 기획 · 콘텐츠 운영 (2인 프로젝트)',
        scope: '아이디어 발제·문제 정의·입력 플로우·추천 결과 UX·MVP 화면 설계·개발 및 배포 공동 진행·블로그/인스타 운영',
        output: '2인 프로젝트 · 아이디어 발제 및 기획 · 콘텐츠 운영 · 개발·배포 공동 진행',
      },
    },
    screenshots: [
...

  {
    ...
    name: 'AI 콘텐츠 생성 자동화',
    title: 'AI 파이프라인으로 22개 브랜드의 피드를 같은 기준으로 만들었다',
    ...
    content: {
      problem:
        '브랜드마다 자료조사·전략·카피·디자인 기준을 처음부터 다시 정하느라 작업 방식이 매번 달라졌고, 품질도 담당자에 따라 편차가 컸다',
      approach: [
      ...
      insights: [
        ...
        { num: '03', title: "속도보다 중요한 건 '누가 해도 같은 품질'이었다", body: '이 프로젝트의 목표는 속도가 아니라 누가 하더라도 같은 품질이 나오는, 재현 가능한 프로세스를 만드는 것이었다.' },
      ],
      results: [
        { label: '제작 산출물', desc: '브랜드 리서치부터 카피 작성, 디자인 적용, QA까지 5단계 파이프라인을 설계해 3개월간 22개 브랜드의 피드 29개를 같은 기준으로 만들었습니다.' },
        { label: '운영 성과', desc: 'Google Sheets로 39개 피드의 진행 현황·캡션·발행 상태를 관리했고, 캡션 v4 포맷과 3-Tier 해시태그 전략을 적용했습니다.' },
        { label: '검수 체계', desc: '발행 전에는 브랜드 정보와 이미지 사용 적합성을 확인하는 사실 확인 게이트를 반드시 통과하도록 했습니다.' },
      ],
      flow: {
        title: '제작 파이프라인',
        layout: 'chain',
        tone: 'process',
        caption: '조사부터 게시까지 5단계 + 단계마다 사람 검수 게이트.',
        steps: [
  ...
  },
  {
    ...
    content: {
      ...
      insights: [
        ...
        { num: '02', title: '오프라인 접점이 팔로워 전환으로 이어졌다', body: '브이로그 27편·숏츠 23편으로 운영 기간 누적 조회수 2.4만 회를 만들었고, 3일간 진행한 학교 축제 팝업에서 팔로워가 464명에서 863명으로 늘었다. 온라인만으로는 부족하다고 판단해 만든 오프라인 접점이 팔로워로 이어졌다.' },
      ...
      results: [
        ...
        { label: '산출물', desc: '의류 라인, ACC·굿즈백·키링, 룩북, 유튜브 브이로그 27편과 숏츠 23편을 직접 기획·제작했습니다. 3일간 진행한 학교 축제 팝업에서 인스타그램 팔로워가 464명에서 863명으로 늘었습니다.' },
      ...
      contribution: {
        ...
        output: '3시즌 출시, 학교 축제 팝업 3일간 인스타 팔로워 464→863명, 팝업 3회 운영, 유튜브 2.4만+ 조회',
      },
    },
    screenshots: [
  ...
  },
  {
    ...
    content: {
      ...
      results: [
        { label: '펀딩 성과', desc: '텀블벅 크라우드펀딩 최종 889,000원, 후원자 36명으로 목표 대비 177%를 달성했습니다. (2024.02~03)' },
        { label: '제작 산출물', desc: '인터뷰집 두 권을 만들었습니다. 먼저 제작한 「애\'Say」는 여러 책방에 무료로 배포했고, 「어른은 아니지만,」은 텀블벅 크라우드펀딩으로 제작했습니다.' },
