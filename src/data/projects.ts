  ...
  },
  {
    ...
    content: {
      ...
      approach: [
        ...
        { num: '04', step: '오프라인 판매', desc: '팝업스토어 3회 (칵테일바 위탁 / 한림대 축제 / 서울플리마켓) 기획·운영' },
        { num: '05', step: '피드백 반영', desc: '고객 리뷰·DM 수집 → 차기 시즌 상품 개선 반영 (사이즈 그레이딩 재설계 포함)' },
      ],
      insights: [
        { num: '01', title: '브랜드는 한 번의 상품이 아니라 시즌의 반복이다', body: '21SS 140벌 완판에 멈추지 않고 고객 리뷰·DM을 모아 사이즈·원단을 다음 시즌에 반영하며 21FW·22SS로 이어갔다. 운영의 핵심은 피드백을 다음 시즌 상품으로 되돌리는 루프였다(사이즈 그레이딩 재설계 포함). 3시즌 누적 판매량은 30% 성장했다.' },
        ...
        { num: '03', title: '온라인만으로는 부족해 채널을 다각화했다', body: '팝업스토어 3회(칵테일바 위탁·한림대 축제·서울 플리마켓)로 오프라인 접점을 만들고 ACC·굿즈백·키링으로 품목을 확장하며, 한 채널에 의존하지 않는 판매 구조를 시도했다.' },
      ],
      results: [
        { label: '21SS 완판', desc: '첫 시즌 자체 제작 의류 140벌 완판 — 이후 21FW · 22SS 연속 출시, 3시즌 누적 판매량 30% 성장' },
        { label: '운영 효율', desc: '출시 리드타임 20% 단축 — 협력업체 소통 창구 단일화 및 통합 일정 관리 도입' },
        { label: 'SNS 성장', desc: '인스타그램 팔로워 464 → 863명 (+86%), 유튜브 조회수 총 2.4만+ (2년 기준)' },
        { label: '오프라인', desc: '팝업스토어 3회 운영 (칵테일바 위탁 · 한림대 축제 · 서울 플리마켓) 채널 다각화' },
      ],
      contribution: {
